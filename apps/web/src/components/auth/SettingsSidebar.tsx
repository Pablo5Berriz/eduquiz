...
export function SettingsSidebar({ items, activeKey, className }: SettingsSidebarProps): JSX.Element {
  return (
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              !active && !danger && 'text-slate-700 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-800',
              danger && active && 'bg-danger-50 text-danger-800 dark:bg-danger-950/40 dark:text-danger-200',
              danger && !active && 'text-danger-700 hover:bg-danger-50 dark:text-danger-300 dark:hover:bg-danger-950/30',
            )}
          >
            {item.label}
          </Link>
